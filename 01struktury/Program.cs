...
namespace _01struktury
{
    class Program
    {
        ...
        private static void ArrayOper()
        {
            ...
            int[] stawkiVAT = new int[10]; //deklaracja 10 elementowej liczb typu int
            stawkiVAT[0] = 8;
            stawkiVAT[9] = 23;
            //stawkiVAT[999] = 0;

            int[] oceny1 = new int[6] { 1, 2, 3, 4, 5, 6 }; //przypisanie wartosci w momencie inicjalizacji
            int[] oceny2 = new int[] { 1, 2, 3, 4, 5, 6 }; //przypisanie wartosci w momencie inicjalizacji
            Console.WriteLine("Liczba elementow:"+ oceny2.Length );
